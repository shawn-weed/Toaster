...
function Home({}: Props) {
  ...
  return (
      <div className="bg-[url('/src/assets/homeImg.jpg')] bg-cover bg-center h-full">
            ...
            <ul className="flex flex-wrap justify-center">
              {links.map(link => (
                <Card
                  ...
                  <div className="gap-4">
                    <h5 id='cardt' className="font-bold text-2xl">{link.title}</h5> 
                    <a className="text-md italic underline" href={link.url}>{link.url}</a>
                  </div>
